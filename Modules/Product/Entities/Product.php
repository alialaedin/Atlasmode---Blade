...
class Product extends Model implements HasMedia, Viewable
{
    ...
    use InteractsWithMedia,InteractsWithViews, HasMorphAuthors,
        HasTags, HasDefaultFields, LogsActivity;
    ...
    protected $appends = ['images', 'total_quantity', 'price', 'rate',
        'major_discount_amount', 'major_image', 'major_gifts', 'major_final_price','views_count'];
    ...
    */
    ...
    # end discount product function

    /**
     *  assign relations Variety,Specifications,SizeChart
     *  When insert Product
     */
    ...
    {
        return $this->varieties()->select('varieties.id','varieties.product_id',
            'varieties.discount', 'varieties.discount_type', 'varieties.price')
    ...
    {
        $product->makeHidden([
            'creatorable_id', 'creatorable_type', 'approved_at', 'published_at',
            'unit_price', 'purchase_price',
            'updaterable_id', 'updaterable_type', ...$other
        ]);
    }
